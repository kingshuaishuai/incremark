...
In Vue, you can create custom container components and pass them to `Incremark`:
...
In Vue, you can create custom code block components and pass them to `Incremark`:
